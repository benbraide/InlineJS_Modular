...
exports.Region = exports.NoAnimation = void 0;
const rootelement_1 = require("./rootelement");
...
const global_1 = require("./managers/global");
const outside_event_1 = require("./managers/outside_event");
const intersection_1 = require("./managers/observers/intersection");
...
class Region {
    constructor(rootElement_) {
        ...
        this.scopes_ = {};
        this.elementScopes_ = {};
        this.elementScopeList_ = new Array();
        ...
        this.rootProxy_ = new proxy_1.RootProxy(this.id_, Region.Get, {});
        this.state_ = new state_1.State(this.id_, Region.Get);
        this.changes_ = new changes_1.Changes(this.id_, Region.Get, Region.GetCurrent);
    ...
    GetElementWith(target, callback) {
        let resolvedTarget = ((target === true) ? this.state_.GetContext(state_1.State.ElementContextKey()) : target);
    ...
    GetElementScope(element) {
        ...
        if (typeof element === 'string') {
            ...
            key = (_a = this.state_.GetContext(state_1.State.ElementContextKey())) === null || _a === void 0 ? void 0 : _a.getAttribute(Region.GetElementKeyName());
        }
        else if (element instanceof rootelement_1.RootElement) {
    ...
    GetIntersectionObserverManager() {
        return (this.intersectionObserverManager_ = (this.intersectionObserverManager_ || new intersection_1.IntersectionObserverManager(this.id_)));
    }
    GetResizeObserver() {
        return (this.resizeObserver_ = (this.resizeObserver_ || new resize_1.ResizeObserver(this.id_)));
    }
    ...
    AddElement(element, check = true) {
        ...
        let id = ((this.lastElementId_ === null) ? (this.lastElementId_ = 0) : ++this.lastElementId_), key = `${this.id_}.${id}`, scope = {
            key: key,
            element: element,
            locals: {},
    ...
    GetLocal(element, key, bubble = true, useNull = false) {
        if (!element) {
            return (useNull ? null : new proxy_1.NoResult());
        }
        if (typeof element !== 'string') {
    ...
    static GetDatabase(createIfNotExists = true) {
        ...
        let db = new database_1.Database(Region.config_.GetAppName() || 'defaultdb');
        db.Open();
    ...
    static SupportsAttributes(element) {
...
Region.components_ = {};
Region.postProcessCallbacks_ = new stack_1.Stack();
Region.forcedPostProcessCallbacks_ = new Array();
Region.lastId_ = 0;
Region.lastSubId_ = null;
Region.entries_ = {};
Region.scopeRegionIds_ = new stack_1.Stack();
Region.hooks_ = new Array();
Region.evaluator_ = new evaluator_1.Evaluator(Region.Get, Region.GetElementKeyName(), Region.scopeRegionIds_);
Region.config_ = new config_1.Config();
Region.database_ = null;
Region.directiveManager_ = new directive_1.DirectiveManager();
Region.globalManager_ = new global_1.GlobalManager(Region.Get, Region.Infer);
Region.outsideEventManager_ = new outside_event_1.OutsideEventManager();
Region.alertHandler_ = null;
Region.processor_ = new processor_1.Processor(Region.config_, Region.directiveManager_);
