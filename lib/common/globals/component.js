...
class ComponentGlobalHandler extends generic_1.GlobalHandler {
    constructor() {
        super('component', () => (id) => region_1.Region.Find(id, true));
    }
}
exports.ComponentGlobalHandler = ComponentGlobalHandler;
class ComponentKeyGlobalHandler extends generic_1.GlobalHandler {
    constructor() {
...
class LocalsGlobalHandler extends generic_1.GlobalHandler {
    constructor() {
...
class GetScopeGlobalHandler extends generic_1.GlobalHandler {
    constructor() {
