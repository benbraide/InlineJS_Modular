...
class WatchGlobalHandler extends generic_1.GlobalHandler {
    constructor() {
...
class WhenGlobalHandler extends generic_1.GlobalHandler {
    constructor() {
...
class OnceGlobalHandler extends generic_1.GlobalHandler {
    constructor() {
