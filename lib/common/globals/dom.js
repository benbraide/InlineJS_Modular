...
class ParentGlobalHandler extends generic_1.GlobalHandler {
    constructor() {
...
class AncestorGlobalHandler extends generic_1.GlobalHandler {
    constructor() {
...
class SiblingGlobalHandler extends generic_1.GlobalHandler {
    constructor() {
...
class FormGlobalHandler extends generic_1.GlobalHandler {
    constructor() {
