...
mocha_1.describe('x-text directive', () => {
    ...
    mocha_1.it('should work on SVG elements', () => __awaiter(void 0, void 0, void 0, function* () {
        document.body.innerHTML = `
            <div x-data="{ foo: 'bar' }">
                <svg>
        ...
        let bootstrap = new bootstrap_1.Bootstrap();
        bootstrap.Attach();
        yield dom_1.waitFor(() => { chai_1.expect(document.querySelector('text').textContent).equal('bar'); });
    }));
