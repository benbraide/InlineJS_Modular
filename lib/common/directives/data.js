...
class DataDirectiveHandler extends generic_1.DirectiveHandler {
    constructor() {
        super('data', (region, element, directive) => {
            ...
            if (directive.value.trim() === region_1.Region.GetConfig().GetDirectiveName(this.key_)) {
                data = {};
            }
            else {
                data = generic_1.DirectiveHandler.Evaluate(region, element, directive.value, null, null, true);
            }
