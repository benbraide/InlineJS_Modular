...
class OnDirectiveHandler extends generic_1.DirectiveHandler {
    constructor() {
        super('on', (region, element, directive) => {
            ...
            let options = generic_1.DirectiveHandler.GetOptions({
                outside: false,
                prevent: false,
                stop: false,
                immediate: false,
                ...
                if (option === 'debounce') {
                    debounce = (((index < (directive.arg.options.length - 1)) ? generic_1.DirectiveHandler.ExtractDuration(directive.arg.options[index + 1], null) : null) || debounce || 250);
                }
