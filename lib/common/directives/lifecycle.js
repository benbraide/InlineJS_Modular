        ...
        super('post', (region, element, directive) => {
            ...
            region.AddElement(element, true).postProcessCallbacks.push(() => {
                if (isNextTick) {
                    ...
                    myRegion.AddNextTickCallback(() => generic_1.DirectiveHandler.BlockEvaluate(myRegion, element, directive.value));
                }
                else {
        ...
        super('bind', (region, element, directive) => {
            ...
            region.GetState().TrapGetAccess(() => {
                ...
                if (!isNextTick) {
                    ...
                    isQueued = true;
                    (_a = region_1.Region.Get(regionId)) === null || _a === void 0 ? void 0 : _a.AddNextTickCallback(() => {
                        isQueued = false;
                        generic_1.DirectiveHandler.BlockEvaluate(region_1.Region.Get(regionId), element, directive.value);
                    });
                }
